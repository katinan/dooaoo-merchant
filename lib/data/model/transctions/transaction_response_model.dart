...
class Data {
  ...
  Data.fromJson(dynamic json) {
    _operations = json['remarks'] != null ? json['remarks'].cast<String>() : [];
...
class Transactions {
  Transactions({List<TransactionsData>? data, String? nextPageUrl, String? path}) {
    _data = data;
  ...
  Transactions.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(TransactionsData.fromJson(v));
      });
    }
  ...
  List<TransactionsData>? get data => _data;
