    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            widget.fromTrx ? Expanded(child: Text(widget.text, style: regularDefault.copyWith(overflow: TextOverflow.ellipsis, color: widget.isFilterBtn ? MyColor.colorBlack : MyColor.colorBlack))) : Expanded(child: Text(widget.text, style: regularDefault.copyWith(color: widget.textColor, overflow: TextOverflow.ellipsis))),
            const SizedBox(
              width: 20,
            ),
