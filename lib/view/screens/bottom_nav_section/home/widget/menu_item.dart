            ...
            Row(
              children: [
                Container(
                  ...
                  child: isSvgImage ? CustomSvgPicture(image: imageSrc, color: MyColor.colorBlack, height: 17.5, width: 17.5) : Image.asset(imageSrc, color: MyColor.colorBlack, height: 17.5, width: 17.5),
                ),
