...
import 'package:viserpay_merchant/view/components/buttons/custom_round_border_shape.dart';
                  ...
                  child: Column(
                    children: [
                      Text(
                        ...
                        style: semiBoldDefault.copyWith(color: widget.isNoInternet ? MyColor.colorRed : MyColor.getTextColor(), fontSize: Dimensions.fontExtraLarge),
                      ),
                      const SizedBox(
                        height: 5,
                      ),
                      widget.isNoInternet
                          ...
                          : Text(
                              widget.message2,
                              style: regularDefault.copyWith(color: MyColor.getContentTextColor(), fontSize: Dimensions.fontLarge),
                              textAlign: TextAlign.center,
                            ),
                      widget.isNoInternet
                          ? const SizedBox(
